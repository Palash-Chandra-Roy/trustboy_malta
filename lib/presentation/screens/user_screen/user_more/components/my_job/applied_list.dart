...
class AppliedListScreen extends StatefulWidget {
  const AppliedListScreen({super.key});

  @override
  State<AppliedListScreen> createState() => _AppliedListScreenState();
}

class _AppliedListScreenState extends State<AppliedListScreen> {
  int selectedTab = 0;
        ...
        child: CustomScrollView(
          slivers: [
            SliverAppBar(
              ...
              centerTitle: true,
              title:  CustomText(
                text:Utils.translatedText(context, Language.appliedList),
                fontSize: 22.0,
              ...
              children: List.generate(
                10,
                  ...
                  return Padding(
                    ...
                    child: const Text('commented-application-card'),
                    // child:  const AppliedCard(),
                  );
                },
              ),
            ),
            ...
            orderTabItems.length,
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  padding: Utils.symmetric(v: 8.0, h: 16.0),
                  margin: Utils.only(
...
List<String> orderTabItems = ['All', 'Pending', 'Accepted', 'Rejected'];
