...
class PaypalScreen extends StatefulWidget {
  const PaypalScreen({super.key, required this.url});
  final Uri url;
...
class _PaypalScreenState extends State<PaypalScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: DefaultAppBar(title: Utils.translatedText(context, 'Paypal Payment')),
      body: Column(
        children: [
          if (_isLoading)
            Center(
  ...
  void _redirect(String url) {
    if (_canRedirect) {
      bool isSuccess = url.contains('/paypal-webview-success') &&
  ...
  //      log(decodedJSON, name: 'paypalScreen');
  ...
  Future<void> getData() async {
    ...
    ''');
      ...
      log("Decoded JSON: $responseJSON", name: 'RazorpayPaymentScreen');
