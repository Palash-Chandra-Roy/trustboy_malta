...
class Errors extends Equatable {
  ...
  final List<String> kycId;
  final Map<String, List<String>> package;
  ...
  Errors copyWith({
    ...
    List<String>? file,
    List<String>? kycId,
    Map<String, List<String>>? package,
  }) {
    return Errors(
  ...
  factory Errors.fromMap(Map<String, dynamic> map) {
    final packageErrors = map.map((key, value) {
    ...
    return Errors(
      ...
      subCategoryId: map['sub_category_id'] != null
          ? List<String>.from(map['sub_category_id'].map((x) => x))
          : [],
      ...
      methodId: map['method_id'] != null
          ...
          : [],
      withdrawAmount: map['amount'] != null
          ? List<String>.from(map['amount'].map((x) => x))
          : [],
      accountInfo: map['description'] != null
          ? List<String>.from(map['description'].map((x) => x))
          : [],
      day:
      ...
      jobType: map['job_type'] != null
          ? List<String>.from(map['job_type'].map((x) => x))
          : [],
      ...
      month: map['month'] != null
          ...
          : [],
      cvc: map['cvc'] != null
          ? List<String>.from(map['cvc'].map((x) => x))
          : [],
      ...
      file: map['file'] != null
          ...
          : [],
      kycId: map['kyc_id'] != null
          ? List<String>.from(map['kyc_id'].map((x) => x))
          : [],
